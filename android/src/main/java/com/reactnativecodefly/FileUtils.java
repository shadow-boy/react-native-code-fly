...
public class FileUtils {
        ...
        for (File sourceFile : sourceDir.listFiles()) {
            if (sourceFile.isDirectory()) {
                copyDirectoryContents(
                        CodeFlyUtils.appendPathComponent(sourceDirectoryPath, sourceFile.getName()),
                        CodeFlyUtils.appendPathComponent(destinationDirectoryPath, sourceFile.getName()));
            } else {
    ...
    public static void deleteDirectoryAtPath(String directoryPath) {
        if (directoryPath == null) {
            CodeFlyUtils.log("deleteDirectoryAtPath attempted with null directoryPath");
            return;
        }
    ...
    public static void deleteFileOrFolderSilently(File file) {
        ...
        if (!file.delete()) {
            CodeFlyUtils.log("Error deleting file " + file.getName());
        }
    }
    ...
    public static void moveFile(File fileToMove, String newFolderPath, String newFileName) {
        ...
        if (!fileToMove.renameTo(newFilePath)) {
            throw new CodeFlyUnknownException("Unable to move file from " +
