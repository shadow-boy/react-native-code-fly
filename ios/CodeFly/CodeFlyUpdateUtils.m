...
@implementation CodeFlyUpdateUtils

NSString * const AssetsFolderName = @"assets";
NSString * const BinaryHashKey = @"CodeFlyBinaryHash";
NSString * const ManifestFolderPrefix = @"CodeFly";
NSString * const BundleJWTFile = @".CodeFlyrelease";
...
NSString * const IgnoreCodeFlyMetadata = @".CodeFlyrelease";
...
+ (BOOL)isHashIgnoredFor:(NSString *) relativePath
{
    ...
    || [relativePath isEqualToString:IgnoreCodeFlyMetadata]
    || [relativePath hasSuffix:[NSString stringWithFormat:@"/%@", IgnoreCodeFlyMetadata]];
}
                                 ...
                                 error:(NSError **)error
{
    ...
    NSString *assetsPath = [CodeFly bundleAssetsPath];
                        ...
                        error:(NSError **)error
{
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:signatureFilePath]) {
        ...
        *error = [CodeFlyErrorUtils errorWithMessage:[NSString stringWithFormat: @"Cannot find signature at %@", signatureFilePath]];
        return nil;
    }
}
